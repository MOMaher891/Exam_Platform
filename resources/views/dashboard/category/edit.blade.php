...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <form class="card-body" id="myForm" method="post" action="{{ route('admin.category.update') }}">
                    @csrf
                    <input type="hidden" name="id" value="{{ $category->id }}">
                    <h4 class="card-title">Edit Category</h4>
                    <p class="card-title-desc">Here are examples : You can edit Category name</p>
                    <div class="row mb-3">
                        <div class="col-md-6 col-lg-6 col-sm-12">
                            <label for="example-text-input" class="col-sm-2 col-form-label">Name</label>
                            <div class="col-sm-10">
                                <input class="form-control" type="text" name="name" placeholder="Ex: Programming"
                                    id="example-text-input" value="{{ $category->name }}" required>
                                @error('name')
