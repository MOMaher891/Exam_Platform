    ...
    <div class="navbar-header">
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block user-dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    <!-- item-->
                    <a class="dropdown-item" href="{{route('inspector.profile.index')}}"><i class="ri-user-line align-middle me-1"></i>
                        Profile</a>
                    ...
                    <a class="dropdown-item text-danger" href="{{ route('inspector.logout') }}"><i
