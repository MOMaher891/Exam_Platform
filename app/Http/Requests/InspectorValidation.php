...
class InspectorValidation extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'img_personal' => 'required|mimes:jpeg,png,pdf,jpg',
            'img_national' => 'required|mimes:jpeg,png,pdf,jpg',
            'img_passport' => 'required|mimes:jpeg,png,pdf,jpg',
            'img_certificate' => 'required|mimes:jpeg,png,pdf,jpg',
            'img_certificate_good_conduct' => 'required|mimes:jpeg,png,pdf,jpg',
        ];
    }
